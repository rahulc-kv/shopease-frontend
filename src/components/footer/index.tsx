      ...
      <footer className="p-4 sm:p-6 bg-[#08364e]">
        <div className="mx-auto max-w-screen-xl">
          <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0 text-gray-600 dark:text-gray-400 w-3/5">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">ONDC</h2>
                <ul className="text-gray-600 dark:text-gray-400">
                  <li className="mb-4">
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="#" className="hover:underline">SellEase™</a>. All Rights Reserved.
            </span>
